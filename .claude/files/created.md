...
| 파일경로                                              | 목적                                                                                                          | 삭제가능 |
| ----------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | -------- |
| `src/clouvel/licensing/paths.py`                      | Centralized ~/.clouvel/ path resolution + JSON I/O helpers (get_clouvel_dir, load_json, save_json)            | ❌       |
...
| 2026-02-28 | can_code TOC + start mode | 수정만: `tools/core.py`, `messages/en.py`, `start/core.py`, `tool_schemas.py`, `tool_dispatch.py`, `tests/test_call_tool.py` |
